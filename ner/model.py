...
class BertNER(IModel):
    ...
    def __init__(self, bert_config_file_name, pretrained_file_name, pretrained_embeddings, vocab_size, tagset_size, hidden_dim):
        self.load_model(bert_config_file_name, pretrained_file_name, pretrained_embeddings, vocab_size, tagset_size, hidden_dim)
    
    def load_model(self, bert_config_file_name, pretrained_file_name, pretrained_embeddings, vocab_size, tagset_size, hidden_dim):
        config = BertConfig.from_json_file(bert_config_file_name)
        self.model = LBertModel.from_pretrained(pretrained_file_name, pretrained_embeddings=pretrained_embeddings, config=config)
